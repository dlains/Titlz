...
@implementation NewTitleViewController
...
{
    [self.delegate newTitleViewController:self didFinishWithSave:NO];
}

-(IBAction) save:(id)sender
{
    [self.delegate newTitleViewController:self didFinishWithSave:YES];
}
