...
-(void) textFieldDidEndEditing:(UITextField*)textField
{
    switch (textField.tag)
    {
        ...
        case BookCollectionTag:
            break;
        default:
            NSLog(@"Invalid NewBookViewController textField.tag value found: %i.", textField.tag);
            break;
    }
...
-(void) textViewDidEndEditing:(UITextView *)textView
{
    switch (textView.tag)
    {
        case BookCommentsTag:
            ...
            break;
        default:
            NSLog(@"Invalid NewBookViewController textView.tag value found: %i.", textView.tag);
            break;
    }
    ...
    if (value.length > 0)
    {
        switch (type)
        {
            ...
            case LookupTypeLocation:
                ...
                break;
            default:
                NSLog(@"Invalid LookupType found in NewBookViewController::lookupViewController:didSelectValue:withLookupType: %i.", type);
                break;
        }
    }
...
-(NSInteger) tableView:(UITableView*)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    switch (section)
    {
        ...
        default:
            NSLog(@"Invalid NewBookViewController section found: %i.", section);
            return 0;
    }
}
...
-(UITableViewCell*) tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    switch (indexPath.section)
    {
        ...
        case BookCollectionSection:
            ...
            break;
        default:
            NSLog(@"Invalid NewBookViewController section found: %i.", indexPath.section);
            break;
    }
...
-(UITableViewCell*) configureTitleCellAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    switch (indexPath.row)
    {
        case BookTitleRow:
            ...
            break;
        default:
            NSLog(@"Invalid NewBookViewController Title section row found: %i.", indexPath.row);
            break;
    }
...
-(UITableViewCell*) configureDetailsCellAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row)
    {
        ...
        case BookSeriesNameRow:
            cell.fieldLabel.text = NSLocalizedString(@"Series Name", @"NewBookViewController seriesName field label.");
        ...
        case BookPublisherRow:
            ...
            break;
        default:
            NSLog(@"Invalid NewBookViewController Data section row found: %i.", indexPath.row);
            break;
    }
...
-(UITableViewCell*) configureInstanceDetailsCellAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row)
    {
        ...
        case BookLastReadRow:
            cell.fieldLabel.text = NSLocalizedString(@"Last Read", @"NewBookViewController lastRead data field label.");
        ...
        case BookLocationRow:
            cell.fieldLabel.text = NSLocalizedString(@"Location", @"NewBookViewController location data field label.");
